=== Smartarget - Get 40% more sales, improve user engagement with 25+ free apps. ===
Contributors: erezs
...
## Improve User Engagement With Smartarget.

Make it easy for your site visitors to contact you through their mobile phones with click-to-call, Whatsapp Message, Telegram Chat, Viber, TikTok, WeChat, Weibo, Line, Skype, Facebook Messennger or Email ability from anywhere on your website.

Smartarget.online Integration which allows you to communicate with your customers easily, also with the help of chat, email, phone etc. It is designed specifically for the WordPress community. With the help of Smartarget you can also promote your sales, special discount, special offers etc.

Use our communication feeatures and allow your users to contact you easily by Whatspp, Email, Phone and more.

[youtube https://www.youtube.com/watch?v=0ho2QdnbT9Y]

### Main Features

- Allow customers to contact you using Whatsapp.
- Allow customers to contact you using Facebook Messenger.
- Allow customers to contact you using Line Messenger.
- Allow customers to contact you using Viber.
- Allow customers to contact you using Telegram.
- Allow customers to contact you using WeChat.
...
- Show users special offer before they leave your website with Exit Popup.
- Message Bar - Display a message bar on your page (for example cookie banner).
- etc.

### Smartarget – Contact Us Pro Features:
Pro version overcomes your limitations with lite version of Smartarget – Contact Us Pro Features.

> **Smartarget – Contact Us [PRO](https://smartarget.online/page_pricing.html) Plugin Features**
>
> * Unlimited Clicks
> * Unlimited Apps
> * Apps visiblity on all pages
> * Additional features per app

BUY Smartarget.online Integration Pro Features : [Buy Now](https://smartarget.online)
...
[youtube https://www.youtube.com/watch?v=fcHnN23Pdcc]
...
Our plugin is the only one you need, but just to give you more confidence, you can simply check our demo page to see exactly how the Whatsapp chat will look on your WordPress website. Check our [Demo page here](https://app.smartarget.online/#/preview/wordpress/whatsapp "Demo page here").
...
Popup by Smartarget works both on computer and mobile devices!


### Exit Popup - Reduce Customers Churn
...
It takes only a few minutes to create the popup of your dreams. Exit Popup works on desktop devices only because it recognizes the mouse cursor movements which don't exist in mobile devices. If you would like to have a popup for both desktop and mobile devices, we suggest using our regular Popup app.


### Popup Forms - Grow your mailing list with Popup Forms

You spend a lot of time and money to bring customers to your website, you better want to have their email in order to make sure they will get your newsletter in the future. Using Popup Forms by Smartarget will help you to collect emails of customers by showing a popup when they visit your website.

- Collect email leads and grow your mailing list
- Choose the app behavior, if it should pop automatically or by clicking on a button
- Pick colors of the popup text, buttons and icon
- Choose the frequency of the popup in case user dismissed the popup
- Over 100 icons available to fit your messaging
- Get notification by email or Telegramm for every filled form

## 🗣 Social Follow Us - Grow your social media follower count faster
Smartarget Social Follow Us adds customizable links to your social media profiles so that your customers can follow you on their favorite social media platform.
Converting your customers into followers is not just about improving your engagement with them. It also allows them to directly communicate with you in case they have a question or want to provide feedback.
Customers who engage with your brand are more likely to purchase additional products or services, share your content with their network, and bring new leads to your site.
Smartarget Social Follow support the following social media platforms:
...
5. Add your website and configure Whatsapp - Contact Us app for your website
6. Go to Integration and copy the User ID to the input text box to this page
...
Yes! You can simply see the power of Smartarget in our <a href="https://smartarget.online/demo.html" target="_blank">demo page</a>.
...
Yes! Free plan includes unlimited clicks and apps, up to 2 websites.
At the first 14 days apps will be visible on all pages.

= What happen after the 14 days trial? =

The apps will be visible on the homepage + «Powered by Smartarget». All features and apps will remain the same 🙂

= I don't know how to integrate it on my website =

You can [contact us](https://smartarget.online/page_contact.html) and we will be glad to help you.

== Screenshots ==

1. Contact Us - All in one app on desktop
2. Contact Us - All in one app on mobile
3. Information Message app on desktop
4. Information Message app on mobile
5. FAQ app on desktop
6. Call Button app on desktop
7. More Free Smartarget Apps
8. Smartarget Reports and Analytics
...
= 1.2.18 =
* Nothing to do. All is working! Check the new Whatsapp and Facebook Messenger settings for new features.

= 1.2.20 =
* Just install the update, the popups will be updated automatically

= 1.2.21 =
* Just install the update, the social media apps will be updated automatically. Check the TikTok, Instagram and other apps for new features.
